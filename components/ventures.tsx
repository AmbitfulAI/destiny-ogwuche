...
export function Ventures() {
  ...
  return (
    <section id="ventures" className="py-24 bg-background">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 mb-20">
            {ventures.map((venture, index) => (
              <div key={index} className="p-8 border border-border bg-card hover:border-primary/50 transition-colors">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    <h3 className="font-serif text-2xl font-medium text-foreground">{venture.name}</h3>
                    <p className="text-primary font-medium">{venture.role}</p>
                  </div>
                  {venture.link && (
                    <Link 
                      href={venture.link} 
          ...
          <h3 className="font-serif text-3xl font-medium text-foreground mb-12">Innovations and Projects</h3>

          <div className="grid md:grid-cols-2 gap-8">
            {innovations.map((innovation, index) => (
              <div key={index} className="p-6 border border-border bg-card">
                <h4 className="font-serif text-xl font-medium text-foreground mb-1">{innovation.name}</h4>
                <p className="text-primary text-sm font-medium mb-4">{innovation.subtitle}</p>
                <p className="text-muted-foreground text-sm leading-relaxed">{innovation.description}</p>
              </div>
            ))}
          </div>
        </div>
